...
async function drawImage (img,x,y,w=img.width,h=img.height){
...
image = drawImage
loadImage = (src, width, height) => new Promise((resolve, reject) => {
    const img = Object.assign(width ? new Image(width, height) : new Image, {src: src})
